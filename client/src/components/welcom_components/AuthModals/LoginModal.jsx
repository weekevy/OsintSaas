...
const LoginModal = ({ isOpen, onClose, onSwitchToRegister }) => {
    ...
    <div className="p-6 md:p-8">
        ...
        <div className="flex items-center justify-between">
          <label className="flex items-center gap-2 cursor-pointer">
            <input 
              ...
              className="w-4 h-4 bg-white/5 border border-white/10 rounded text-[#00E5FF]" 
            />
          ...
          <button 
            type="button"
            className="text-xs text-[#00E5FF] hover:text-[#00D4EB] transition-colors duration-200"
          >
            Forgot password?
          </button>
        </div>
      ...
      <div className="text-center">
        <p className="text-xs font-bold text-white/20 uppercase tracking-widest">
          New Operator?{' '}
          <button onClick={onSwitchToRegister} className="text-[#00E5FF] hover:text-[#00D4EB] transition-colors duration-200 inline-block">
            Create Account
          </button>
        </p>
      </div>
  ...
  const renderOTPForm = () => (
    <div className="p-6 md:p-8">
      <div className="text-center mb-6">
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Verify Your Identity</h2>
