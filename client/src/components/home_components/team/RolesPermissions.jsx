  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-white font-sans text-base font-bold">Roles & Permissions</h3>
      </div>
        ...
        {roles.map((role, idx) => (
          ...
          >
            <div className="flex justify-between items-start mb-3">
              <h4 className="text-white font-sans font-bold text-base">{role.name}</h4>
              <span className="text-white/40 text-xs font-sans">{role.members} members</span>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mb-3">
              {role.permissions.map((perm, i) => (
                <span
                  key={i}
                  className="px-2 py-1 rounded-lg bg-white/5 border border-white/10 text-white/60 text-[10px] font-sans"
                >
                  {perm}
                </span>
              ))}
