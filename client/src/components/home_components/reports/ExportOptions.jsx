...
const ExportOptions = ({ expanded = false }) => {
  ...
  if (!expanded) {
    return (
      <button className="px-4 py-2 border border-[#00E5FF]/30 text-[#00E5FF] hover:bg-[#00E5FF]/10 transition-all flex items-center gap-2 group text-[10px] font-sans uppercase tracking-[0.08em]">
  ...
  return (
    <div className="space-y-5 glass-card border border-white/10 p-5 relative font-sans">
      {/* Corner brackets */}
      ...
      {/* Format Selection */}
      <div>
        <label className="block text-white/40 text-[8px] font-sans uppercase tracking-[0.12em] mb-2 flex items-center gap-2">
          <svg className="w-3 h-3 text-[#00E5FF]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          ...
          {formats.map((format) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className={`text-[10px] font-sans uppercase tracking-[0.08em] ${selectedFormat === format.id ? 'text-[#00E5FF]' : 'text-white/60 group-hover:text-white'}`}>
                    {format.name}
                  </div>
                  <div className="text-white/30 text-[7px] font-sans uppercase tracking-[0.08em]">{format.description}</div>
                </div>
              </div>
            </button>
          ))}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
          ...
          <div className="space-y-1.5">
            <label className="flex items-center gap-3 p-2 cursor-pointer group border border-transparent hover:border-[#00E5FF]/20 transition-all">
              <input
                type="checkbox"
              ...
              />
              <span className="text-white/50 group-hover:text-white text-[9px] font-sans uppercase tracking-[0.08em] flex items-center gap-2">
      ...
      <div className="flex gap-3 pt-3 border-t border-white/10">
        <button className="flex-1 px-4 py-2 border border-[#00E5FF]/30 bg-[#00E5FF]/10 text-[#00E5FF] hover:bg-[#00E5FF]/20 transition-all text-[9px] font-sans uppercase tracking-[0.08em] flex items-center justify-center gap-2 group relative overflow-hidden">
          <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
            <path d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
          </svg>
          EXPORT NOW
        </button>
        <button className="px-4 py-2 border border-white/10 text-white/50 hover:border-[#00E5FF]/30 hover:text-[#00E5FF] transition-all text-[9px] font-sans uppercase tracking-[0.08em] flex items-center gap-2 group">
