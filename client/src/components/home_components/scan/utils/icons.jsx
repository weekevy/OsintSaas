...
export const getIcon = (iconName, className = "w-6 h-6") => {
  ...
  return icons[iconName] || icons.job;
};

// Helper function to get icon name from module type
export const getIconName = (moduleType) => {
  const iconMap = {
    'job-recruitment': 'job',
    'linkedin': 'linkedin',
    'social-media': 'social',
    'scam-website': 'website',
    'email-leak': 'email',
    'scam-email': 'email-scam',
    'phone-number': 'phone',
    'crypto-wallet': 'crypto'
  };
  return iconMap[moduleType] || 'job';
};
