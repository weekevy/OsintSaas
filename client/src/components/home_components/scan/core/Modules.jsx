  ...
  <label className="flex items-center gap-3 p-3 bg-white/5 border border-white/[0.08] cursor-pointer hover:border-[#00E5FF]/30 transition-colors group md:backdrop-blur-sm">
    <div className="relative">
      ...
      <div className={`w-4 h-4 border transition-all flex items-center justify-center ${
        checked ? 'bg-[#00E5FF] border-[#00E5FF]' : 'bg-transparent border-white/20 group-hover:border-white/40'
      }`}>
        {checked && (
          ...
          {modules.map((module) => (
            ...
            >
              ...
              <div className="relative flex items-start gap-4">
                ...
                <div className="absolute top-0 right-0 w-0 h-0 border-t-[8px] border-r-[8px] border-t-[#00E5FF]/20 border-r-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
            </button>
          ))}
        </div>
    ...
    <div className="grid lg:grid-cols-3 gap-6 font-sans">
      <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-card p-5">
            ...
            <div className="flex flex-wrap gap-2">
              {savedConfigs.map(config => (
                <div
                  key={config.id}
                  className={`group relative px-2 py-1 text-[9px] font-sans uppercase tracking-[0.08em] cursor-pointer transition-all ${
        ...
        <div className="glass-card p-5">
          ...
          <div className="grid grid-cols-3 gap-3 mb-4">
            <div className="bg-white/5 border border-white/[0.08] p-2 text-center backdrop-blur-xl">
          ...
          <div className="text-center py-4 bg-white/5 border border-white/[0.08] backdrop-blur-xl">
      ...
      <div className="space-y-6">
        <div className="glass-card p-5 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2 text-center">
              <div className="bg-white/5 border border-white/[0.08] p-2 backdrop-blur-xl">
            ...
            <button 
              ...
              className="w-full mt-3 py-2 border border-[#00E5FF]/30 text-[#00E5FF] hover:bg-[#00E5FF]/10 transition-all font-sans text-[9px] uppercase tracking-[0.08em] flex items-center justify-center gap-2 disabled:opacity-50"
            >
              {isLoading ? (
                <>
                  <div className="w-3 h-3 border border-white/20 border-t-white rounded-full" />
                  STARTING...
                </>
              ) : (
                <>
        ...
        <div className="glass-card p-5">
          ...
          <div className="space-y-2">
            {[1, 2, 3].map((_, i) => (
              <div key={i} className="flex items-center justify-between text-[8px] font-sans p-2 bg-white/5 border border-white/[0.08] backdrop-blur-xl">
            ...
            <button className="w-full mt-2 text-[7px] text-white/40 hover:text-[#00E5FF] transition-colors font-sans uppercase tracking-[0.08em]">
              VIEW ALL →
            </button>
          </div>
        </div>
      ...
      {showSaveDialog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="relative glass-card p-6 max-w-md w-full overflow-hidden">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="px-3 py-1.5 border border-[#00E5FF]/30 text-[#00E5FF] hover:bg-[#00E5FF]/10 text-[9px] font-sans uppercase tracking-[0.08em] transition-all disabled:opacity-50 flex items-center gap-2"
              >
                {loading ? (
                  <>
                    <div className="w-3 h-3 border border-white/20 border-t-white rounded-full" />
